...
<div class="customer-edit-page customer-form-page customer-management content-shell">
    ...
    <div class="form-container ui-form-card">
        <form class="ui-form ui-form-layout"
            ...
            <input type="hidden" name="customer_name" value="<c:out value="${customer.customerName}" />">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" id="customer_name_display" value="<c:out value="${customer.customerName}" />" readonly
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="first_introduction_year" name="first_introduction_year"
                           value="<c:out value="${customer.firstIntroductionYear}" />" min="2000" max="2030">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" id="db_name" name="db_name" value="<c:out value="${customer.dbName}" />">
                </div>
                <div class="form-group">
                    <label for="vertica_version">Vertica 버전</label>
                    <input type="text" id="vertica_version" name="vertica_version" value="<c:out value="${customer.verticaVersion}" />">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="date" id="vertica_eos" name="vertica_eos" value="<c:out value="${customer.verticaEos}" />">
                </div>
                <div class="form-group">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" id="os" name="os" value="<c:out value="${customer.os}" />">
                </div>
                <div class="form-group">
                    <label for="nodes">노드 수</label>
                    <input type="number" id="nodes" name="nodes" value="<c:out value="${customer.nodes}" />" min="1">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" id="license_size" name="license_size" value="<c:out value="${customer.licenseSize}" />">
                </div>
                <div class="form-group">
                    <label for="said">SAID</label>
                    <input type="text" id="said" name="said" value="<c:out value="${customer.said}" />">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" id="manager_name" name="manager_name" value="<c:out value="${customer.managerName}" />">
                </div>
                <div class="form-group">
                    <label for="sub_manager_name">부담당자</label>
                    <input type="text" id="sub_manager_name" name="sub_manager_name" value="<c:out value="${customer.subManagerName}" />">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <textarea id="os_storage_config" name="os_storage_config" rows="3"><c:out value="${customer.osStorageConfig}" /></textarea>
                </div>
                <div class="form-group">
                    <label for="backup_config">백업 구성</label>
                    <textarea id="backup_config" name="backup_config" rows="3"><c:out value="${customer.backupConfig}" /></textarea>
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" id="etl_tool" name="etl_tool" value="<c:out value="${customer.etlTool}" />">
                </div>
                <div class="form-group">
                    <label for="bi_tool">BI Tool</label>
                    <input type="text" id="bi_tool" name="bi_tool" value="<c:out value="${customer.biTool}" />">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" id="db_encryption" name="db_encryption" value="<c:out value="${customer.dbEncryption}" />">
                </div>
                <div class="form-group">
                    <label for="cdc_tool">CDC Tool</label>
                    <input type="text" id="cdc_tool" name="cdc_tool" value="<c:out value="${customer.cdcTool}" />">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group full-width">
                    ...
                    <textarea id="note" name="note" rows="3"><c:out value="${customer.note}" /></textarea>
                </div>
            </div>
